...
{
    #########################数据表#########################################
    const ACTIVITY_BANNER_INFO = 'activity_banner_info';
    const ACTIVITY_GOODS_INFO = 'activity_goods_info';
    const ACTIVITY_GOODS_LIST = 'activity_goods_list';
    const ACTIVITY_SLOTS = 'activity_slots';
    const ACTIVITY_SLOTS_COUPON = 'activity_slots_coupon';
