...
//    'exception_tmpl'         => WEB_CODE_ROOT.'/project/error.php',
    ...
    //consul 配置
//    'consule_type' => 'consul',
//        'consule_hosts' => 'consul-qa.taojiji.work',
//    'consule_hosts' => '192.168.2.72:8500',
];
...
$unify = require (WEB_CODE_ROOT.'/project/unify.php');
return array_merge($config,$domain,$filter,$redis,$nickname,$unify);
