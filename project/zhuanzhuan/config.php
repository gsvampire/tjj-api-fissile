...
//    'exception_tmpl'         => WEB_CODE_ROOT.'/project/error.php',
    ...
    #赚赚8.8活动开始结束时间
    'zhuanzhuan_anniversary_start_time' => '2019-07-31 17:00:00',
    'zhuanzhuan_anniversary_end_time' => '2019-08-28 23:59:59',
];
$status = require (WEB_CODE_ROOT.'/project/zhuanzhuan/status.php');
$domain = require (WEB_CODE_ROOT.'/config/domain.php');
$filter = require (WEB_CODE_ROOT.'/config/filter.php');
$message = require (WEB_CODE_ROOT.'/project/zhuanzhuan/message.php');
...
return array_merge($config,$domain,$filter,$message,$redis,$status,$domain_java,$wx_conf,$nickname);
