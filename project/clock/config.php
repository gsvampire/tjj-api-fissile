...
$config = [
    ...
    //模块列表
    'MODULE_ALLOW_LIST'   => array('v1_0_0'),
    // 默认模块名
    'default_module'         => 'v1_0_0',
    // 禁止访问模块
...
$status = require (WEB_CODE_ROOT.'/project/clock/status.php');
$domain = require (WEB_CODE_ROOT.'/config/domain.php');
$filter = require (WEB_CODE_ROOT.'/config/filter.php');
$message = require (WEB_CODE_ROOT.'/project/clock/message.php');
